...
import {ProductSorterProps} from '@helpers/types';

/**
 * ProductSorter component that displays a sorting indicator based on the current sort direction.
 ...
 */
const ProductSorter = ({sortColumn, currentSort}: ProductSorterProps): React.JSX.Element | null=> {
